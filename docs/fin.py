    ...
    for _ in range(n):
        for e4 in list(dict_esp4) :
            if dict_esp4[e4][0]>=age_max_esp4 :           #Si l'animal est trop vieux
                ...
                if math.sqrt((perimetre_vision(1,e4[0],e4[1],3,Terrain_final)[0]-e4[0])**2+(perimetre_vision(1,e4[0],e4[1],3,Terrain_final)[1]-e4[1])**2)<=math.sqrt(2) :
                ...
                if math.sqrt((perimetre_vision(1,e4[0],e4[1],4,Terrain_final)[0]-e4[0])**2+(perimetre_vision(1,e4[0],e4[1],4,Terrain_final)[1]-e4[1])**2)<=math.sqrt(2) :
        ...
        for e3 in list(dict_esp3) :
            if dict_esp3[e3][0]>=age_max_esp3 :           #Si l'animal est trop vieux
                ...
                if math.sqrt((perimetre_vision(1,e3[0],e3[1],2,Terrain_final)[0]-e3[0])**2+(perimetre_vision(1,e3[0],e3[1],2,Terrain_final)[1]-e3[1])**2)<=math.sqrt(2) :
                ...
                if math.sqrt((perimetre_vision(1,e3[0],e3[1],3,Terrain_final)[0]-e3[0])**2+(perimetre_vision(1,e3[0],e3[1],3,Terrain_final)[1]-e3[1])**2)<=math.sqrt(2) :
        ...
        for e2 in list(dict_esp2) :
            if dict_esp2[e2][0]>=age_max_esp2 :           #Si l'animal est trop vieux
                ...
                if math.sqrt((perimetre_vision(1,e2[0],e2[1],1,Terrain_final)[0]-e2[0])**2+(perimetre_vision(1,e2[0],e2[1],1,Terrain_final)[1]-e2[1])**2)<=math.sqrt(2) :
                ...
                if math.sqrt((perimetre_vision(1,e2[0],e2[1],2,Terrain_final)[0]-e2[0])**2+(perimetre_vision(1,e2[0],e2[1],2,Terrain_final)[1]-e2[1])**2)<=math.sqrt(2) :
