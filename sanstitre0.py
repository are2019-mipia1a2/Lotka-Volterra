...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 16:32:32 2019
...
per_3=20
per_4=25
faim_e4 = 40      # à partir de combien ils ont faim
faim_e3 =30
faim_e2 =15
amr_e4=10/12  #age de maturité sexuelle
amr_e3=1/2   
amr_e2=1/4
faim_perdue_e4=6      
faim_perdue_e3=8
...
def cgmt(*args) :
    ...
    for ep in list(dict_plante) :
            if dict_plante[ep][1]: #lorsque la plante est mang1ée, 3 tours pour qu'elle repousse
...
esp2=len_e2
esp4=len_e4
plt.plot(esp3, label='prédateur intermédiaire', color='purple')
plt.plot(esp4, label='prédateur', color='blue')
plt.plot(esp2,label="proie", color='grey')
plt.legend()
plt.show()
